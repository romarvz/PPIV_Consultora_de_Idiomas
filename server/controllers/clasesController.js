...
exports.listarClases = async (req, res) => {
  try {
    ...
    const resultado = await clasesService.listarClases(filtros, req.pagination);
...
exports.registrarAsistencia = async (req, res) => {
  try {
    ...
    const registradoPor = req.user._id;
...
exports.obtenerEstadisticasAsistencia = async (req, res) => {
  try {
    ...
    if (req.user.role === 'student' && req.user._id.toString() !== estudianteId) {
